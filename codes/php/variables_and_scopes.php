...
(function () use ($console_log, $string_interpolation) {
    $yyy = "local_scope, 10";
    $aaa = "local_scope, 20";
...
(function () use ($console_log, $string_interpolation, $yyy) {
    $yyy = "local_scope, 10";
    $aaa = "local_scope, 20";
    $console_log($string_interpolation("yyy: ", $yyy)); // yyy: local_scope, 10
    $console_log($string_interpolation("aaa: ", $aaa)); // aaa: local_scope, 20
...
// local scope, can access variables from enclosing (outer) function or even global variables but to modify them need to use "use (&$something)". "use (&$something)" only works in anonymous function

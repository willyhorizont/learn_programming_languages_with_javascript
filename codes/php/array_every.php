...
$array_every_v1 = function ($callback_function, $any_array) {
...
$array_every_v2 = function ($callback_function, $any_array) {
...
$array_every_v3 = function ($callback_function, $any_array) {
...
$array_every_v4 = function ($callback_function, $any_array) {
    // JavaScript-like Array.every() function $array_every_v4
    $array_item_index = 0;
    foreach ($any_array as $object_key => $object_value) {
        if ($callback_function($object_value, $array_item_index, $any_array) === false) return false;

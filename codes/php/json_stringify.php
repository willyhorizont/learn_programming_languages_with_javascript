...
console_log(string_interpolation("numbers: ", str_replace("{", "{ ", str_replace("}", " }", str_replace(",", ", ", str_replace(":", ": ", json_encode($numbers)))))));
...
console_log(string_interpolation("products: ", str_replace("/\n$/", "", json_encode($products, JSON_PRETTY_PRINT))));

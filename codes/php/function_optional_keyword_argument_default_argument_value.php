...
function function_v1_optional_keyword_argument_default_argument_value($anything, $pretty = false) {
    global $console_log, $string_interpolation;
...
$function_v2_optional_keyword_argument_default_argument_value = function ($anything, $pretty = false) use ($console_log, $string_interpolation) {
    $console_log($string_interpolation("main function argument: ", [$anything]));
    $console_log($string_interpolation('optional function keyword argument default value "pretty": ', [$pretty]));
};

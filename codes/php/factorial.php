...
$factorial_v1 = function ($any_number) use ($js_like_type, $get_type) {
    if ($get_type($any_number) !== $js_like_type["Numeric"]) throw new Exception("Argument should be a number");
    if ($any_number < 0) throw new Exception("Argument should be >= 0");
    if ($any_number === 0) return 1;
    $result = 1;
    $i = $any_number;
    while (true) {
        $result *= $i;
...
$factorial_v2 = function ($any_number) use ($js_like_type, $get_type) {
    if ($get_type($any_number) !== $js_like_type["Numeric"]) throw new Exception("Argument should be a number");
    if ($any_number < 0) throw new Exception("Argument should be >= 0");
    if ($any_number === 0) return 1;
    $result = 1;
...
$factorial_v3 = function ($any_number) use ($js_like_type, $get_type) {
    if ($get_type($any_number) !== $js_like_type["Numeric"]) throw new Exception("Argument should be a number");
    if ($any_number < 0) throw new Exception("Argument should be >= 0");
    if ($any_number === 0) return 1;
    $result = 1;
    for ($i = $any_number; ($i >= 1); $i -= 1) {
        $result *= $i;
    }
    return $result;
};

$factorial_v4 = function ($any_number) use ($js_like_type, $get_type, &$factorial_v4) {
    if ($get_type($any_number) !== $js_like_type["Numeric"]) throw new Exception("Argument should be a number");
    if ($any_number < 0) throw new Exception("Argument should be >= 0");
    if ($any_number === 0) return 1;

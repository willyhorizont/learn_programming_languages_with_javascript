...
echo("\n" . "JSON_OBJECT?.foo?.bar or JSON_OBJECT?.['foo']?.['bar']: " . json_encode(@$JSON_OBJECT["foo"]["bar"]));
// JSON_OBJECT?.foo?.bar or JSON_OBJECT?.['foo']?.['bar']: "baz"

echo("\n" . "JSON_OBJECT?.foo?.baz or JSON_OBJECT?.['foo']?.['baz']: " . json_encode(@$JSON_OBJECT["foo"]["baz"]));
// JSON_OBJECT?.foo?.baz or JSON_OBJECT?.['foo']?.['baz']: null

echo("\n" . "JSON_OBJECT?.fruits?.[2] or JSON_OBJECT?.['fruits']?.[2]: " . json_encode(@$JSON_OBJECT["fruits"][2]));
// JSON_OBJECT?.fruits?.[2] or JSON_OBJECT?.['fruits']?.[2]: "banana"

echo("\n" . "JSON_OBJECT?.fruits?.[5] or JSON_OBJECT?.['fruits']?.[5]: " . json_encode(@$JSON_OBJECT["fruits"][5]));

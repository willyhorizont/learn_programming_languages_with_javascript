...
fun main() {
    ...
    println("\n// JavaScript-like Array.every() in Kotlin mutableListOf<Any?>")
    ...
    println("// using Kotlin Array.every() built-in function \"all\"")
    ...
    println("\n// JavaScript-like Array.every() in Kotlin mutableListOf<mutableMapOf<String, Any?>>")

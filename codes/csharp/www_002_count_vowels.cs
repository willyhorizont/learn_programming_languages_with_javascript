...
class Program {
    static void Main(string[] Args) {
        ...
        */
        dynamic CountVowelsV1 = (Func<string, int>)((string AString) => ((IEnumerable<char>)(AString.ToCharArray())).Aggregate(0, (Func<int, char, int>)((int Result, char ACharacter) => ((new List<dynamic>() {"a", "i", "u", "e", "o", "A", "I", "U", "E", "O"}).Contains(ACharacter.ToString()) ? (Result + 1) : Result))));
        Console.WriteLine(CountVowelsV1("Hello World")); // 3

        dynamic CountVowelsV2 = (Func<string, int>)((string AString) => ((IEnumerable<char>)(AString.ToCharArray())).Aggregate(0, (Func<int, char, int>)((int Result, char ACharacter) => ((new List<dynamic>() {"A", "I", "U", "E", "O"}).Contains(ACharacter.ToString().ToUpper()) ? (Result + 1) : Result))));
        Console.WriteLine(CountVowelsV2("Hello World")); // 3

        dynamic CountVowelsV3 = (Func<string, int>)((string AString) => ((IEnumerable<char>)(AString.ToCharArray())).Aggregate(0, (Func<int, char, int>)((int Result, char ACharacter) => ("aiueoAIUEO".Contains(ACharacter.ToString()) ? (Result + 1) : Result))));
        Console.WriteLine(CountVowelsV3("Hello World")); // 3

        dynamic CountVowelsV4 = (Func<string, int>)((string AString) => ((IEnumerable<char>)(AString.ToCharArray())).Aggregate(0, (Func<int, char, int>)((int Result, char ACharacter) => ("AIUEO".Contains(ACharacter.ToString().ToUpper()) ? (Result + 1) : Result))));

...
// func stringInterpolation(restArguments ...any) {
//     return arrayReduce(func(currentResult any, currentArgument any, _ int, _ array) any {
//         return currentResult + 
//     }, restArguments, "")
// }

func main() {
	fmt.Println("// JavaScript-like console.log() in Go")

    var anyString any = "foo"
    var anyNumeric any = 123
    var anyBoolean any = true
    var anyNull any = nil
    var anyArray any = array{1, 2, 3}
    var anyObject any = object{"foo": "bar"}

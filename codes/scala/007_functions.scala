...
val simpleCalculatorResult1 = simpleCalculator.asInstanceOf[mutable.Map[String, Any]]("exponentiation").asInstanceOf[(Int, Int) => Int](2, 4)
val simpleCalculatorResult2 = simpleCalculator.asInstanceOf[mutable.Map[String, Any]]("multiplication").asInstanceOf[(Int, Int) => Int](7, 5)
val simpleCalculatorResult3 = simpleCalculator.asInstanceOf[mutable.Map[String, Any]]("addition").asInstanceOf[(Int, Int) => Int](9, 3)
val simpleCalculatorResult4 = simpleCalculator.asInstanceOf[mutable.Map[String, Any]]("subtraction").asInstanceOf[(Int, Int) => Int](35, 8)

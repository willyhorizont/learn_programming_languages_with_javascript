...
Module Program
    ...
    Sub Main(Args As String())
        Console.WriteLine($"{Environment.NewLine}' JavaScript-like Array.map() in Visual Basic (.NET) List(Of Object)")
        ...
        Console.WriteLine($"{Environment.NewLine}' JavaScript-like Array.map() in Visual Basic (.NET) List(Of Dictionary(Of String, Object))")

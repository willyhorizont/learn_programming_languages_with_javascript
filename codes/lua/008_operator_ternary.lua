...
CORRECT_ANSWER = "foo"
console_log(string_interpolation("correct answer: ", {CORRECT_ANSWER}))

console_log("-- using Ternary Operator function \"ternary\"")

my_answer = "bar"
console_log(string_interpolation("my answer: ", {my_answer}))
console_log(string_interpolation("is my answer correct: ", ternary((my_answer == CORRECT_ANSWER), (function () return ("correct!") end), (function () return ("wrong!") end))))

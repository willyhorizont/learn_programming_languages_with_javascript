...
console_log("-- Variadic Function Rest Arguments in Lua")

function function_variadic(...)
    local rest_arguments = {...}
    console_log("function variadic rest arguments: ", json_stringify(rest_arguments))
end
function_variadic(1, 2, 3, 4)

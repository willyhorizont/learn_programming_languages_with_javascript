...
console_log(string_interpolation('JSON_OBJECT?.foo?.bar or JSON_OBJECT?.["foo"]?.["bar"]: ', json_stringify(optional_chaining(function () return (JSON_OBJECT["foo"]["bar"]) end))))
-- JSON_OBJECT?.foo?.bar or JSON_OBJECT?.["foo"]?.["bar"]: "baz"

console_log(string_interpolation('JSON_OBJECT?.foo?.baz or JSON_OBJECT?.["foo"]?.["baz"]: ', json_stringify(optional_chaining(function () return (JSON_OBJECT["foo"]["baz"]) end))))
-- JSON_OBJECT?.foo?.baz or JSON_OBJECT?.["foo"]?.["baz"]: null

console_log(string_interpolation('JSON_OBJECT?.fruits?.[2] or JSON_OBJECT?.["fruits"]?.[2]: ', json_stringify(optional_chaining(function () return (JSON_OBJECT["fruits"][2]) end))))
-- JSON_OBJECT?.fruits?.[2] or JSON_OBJECT?.["fruits"]?.[2]: "mango"

console_log(string_interpolation('JSON_OBJECT?.fruits?.[5] or JSON_OBJECT?.["fruits"]?.[5]: ', json_stringify(optional_chaining(function () return (JSON_OBJECT["fruits"][5]) end))))
-- JSON_OBJECT?.fruits?.[5] or JSON_OBJECT?.["fruits"]?.[5]: null

console_log(string_interpolation('JSON_OBJECT?.get_rectangle_area?.(7, 5) or JSON_OBJECT?.["get_rectangle_area"]?.(7, 5): ', json_stringify(optional_chaining(function () return (JSON_OBJECT["get_rectangle_area"](7, 5)) end))))
-- JSON_OBJECT?.get_rectangle_area?.(7, 5) or JSON_OBJECT?.["get_rectangle_area"]?.(7, 5): null

console_log(string_interpolation('JSON_OBJECT?.get_circle_area?.(7) or JSON_OBJECT?.["get_circle_area"]?.(7): ', json_stringify(optional_chaining(function () return (JSON_OBJECT["get_circle_area"](7)) end))))

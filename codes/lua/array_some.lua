...
function array_some_v1(callback_function, any_array)
    ...
    for array_item_index, array_item in ipairs(any_array) do
        ...
        if (is_condition_match == true) then break end
    end
    return is_condition_match
end

function array_some_v2(callback_function, any_array)
    -- JavaScript-like Array.some() function array_some_v2
    local is_condition_match = false
    for array_item_index, array_item in ipairs(any_array) do
        is_condition_match = callback_function(array_item, array_item_index, any_array)
        if (is_condition_match == true) then return is_condition_match end
    end
    return is_condition_match
end

function array_some_v3(callback_function, any_array)
    ...
    for array_item_index, array_item in ipairs(any_array) do
        ...
        if (is_condition_match == true) then return true end
    end
    return false
end

function array_some_v4(callback_function, any_array)
    -- JavaScript-like Array.some() function array_some_v4
    for array_item_index, array_item in ipairs(any_array) do
        if (callback_function(array_item, array_item_index, any_array) == true) then return true end
    end
...
console_log("\n-- JavaScript-like Array.some() in Lua table")
...
console_log("\n-- JavaScript-like Array.some() in Lua table of hash-tables")
...
is_any_product_price_less_than_500 = array_some_v1(function (product) return (optional_chaining(function () return (product["price"]) end) < 500) end, products)
console_log(string_interpolation("is any product price < 500: ", is_any_product_price_less_than_500))
-- is any product price < 500: true

is_any_product_price_more_than_500 = array_some_v1(function (product) return (optional_chaining(function () return (product["price"]) end) > 500) end, products)
...
is_any_product_price_less_than_500 = array_some_v2(function (product) return (optional_chaining(function () return (product["price"]) end) < 500) end, products)
console_log(string_interpolation("is any product price < 500: ", is_any_product_price_less_than_500))
-- is any product price < 500: true

is_any_product_price_more_than_500 = array_some_v2(function (product) return (optional_chaining(function () return (product["price"]) end) > 500) end, products)
console_log(string_interpolation("is any product price < 500: ", is_any_product_price_more_than_500))
-- is any product price > 500: false

console_log("-- using JavaScript-like Array.some() function \"array_some_v3\"")

is_any_product_price_less_than_500 = array_some_v3(function (product) return (optional_chaining(function () return (product["price"]) end) < 500) end, products)
console_log(string_interpolation("is any product price < 500: ", is_any_product_price_less_than_500))
-- is any product price < 500: true

is_any_product_price_more_than_500 = array_some_v3(function (product) return (optional_chaining(function () return (product["price"]) end) > 500) end, products)
console_log(string_interpolation("is any product price < 500: ", is_any_product_price_more_than_500))
-- is any product price > 500: false

console_log("-- using JavaScript-like Array.some() function \"array_some_v4\"")

is_any_product_price_less_than_500 = array_some_v4(function (product) return (optional_chaining(function () return (product["price"]) end) < 500) end, products)
console_log(string_interpolation("is any product price < 500: ", is_any_product_price_less_than_500))
-- is any product price < 500: true

is_any_product_price_more_than_500 = array_some_v4(function (product) return (optional_chaining(function () return (product["price"]) end) > 500) end, products)
console_log(string_interpolation("is any product price < 500: ", is_any_product_price_more_than_500))
-- is any product price > 500: false

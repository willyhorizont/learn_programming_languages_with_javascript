...
function array_every_v1(callback_function, any_array)
    ...
    for array_item_index, array_item in ipairs(any_array) do
        ...
        if (is_condition_match == false) then break end
    end
    return is_condition_match
end

function array_every_v2(callback_function, any_array)
    -- JavaScript-like Array.every() function array_every_v2
    local is_condition_match = true
    for array_item_index, array_item in ipairs(any_array) do
        is_condition_match = callback_function(array_item, array_item_index, any_array)
        if (is_condition_match == false) then return is_condition_match end
    end
    return is_condition_match
end

function array_every_v3(callback_function, any_array)
    ...
    for array_item_index, array_item in ipairs(any_array) do
        ...
        if (is_condition_match == false) then return false end
    end
    return true
end

function array_every_v4(callback_function, any_array)
    -- JavaScript-like Array.every() function array_every_v4
    for array_item_index, array_item in ipairs(any_array) do
        if (callback_function(array_item, array_item_index, any_array) == false) then return false end
    end
...
console_log("\n-- JavaScript-like Array.every() in Lua table")
...
console_log("\n-- JavaScript-like Array.every() in Lua table of hash-tables")
...
is_all_product_price_less_than_500 = array_every_v1(function (product) return (optional_chaining(function () return (product["price"]) end) < 500) end, products)
...
is_all_product_price_more_than_500 = array_every_v1(function (product) return (optional_chaining(function () return (product["price"]) end) > 500) end, products)
...
is_all_product_price_less_than_500 = array_every_v2(function (product) return (optional_chaining(function () return (product["price"]) end) < 500) end, products)
console_log(string_interpolation("is all product price < 500: ", {is_all_product_price_less_than_500}))
-- is all product price < 500: true

is_all_product_price_more_than_500 = array_every_v2(function (product) return (optional_chaining(function () return (product["price"]) end) > 500) end, products)
console_log(string_interpolation("is all product price > 500: ", {is_all_product_price_more_than_500}))
-- is all product price > 500: false

console_log("-- using JavaScript-like Array.every() function \"array_every_v3\"")

is_all_product_price_less_than_500 = array_every_v3(function (product) return (optional_chaining(function () return (product["price"]) end) < 500) end, products)
console_log(string_interpolation("is all product price < 500: ", {is_all_product_price_less_than_500}))
-- is all product price < 500: true

is_all_product_price_more_than_500 = array_every_v3(function (product) return (optional_chaining(function () return (product["price"]) end) > 500) end, products)
console_log(string_interpolation("is all product price > 500: ", {is_all_product_price_more_than_500}))
-- is all product price > 500: false

console_log("-- using JavaScript-like Array.every() function \"array_every_v4\"")

is_all_product_price_less_than_500 = array_every_v4(function (product) return (optional_chaining(function () return (product["price"]) end) < 500) end, products)
console_log(string_interpolation("is all product price < 500: ", {is_all_product_price_less_than_500}))
-- is all product price < 500: true

is_all_product_price_more_than_500 = array_every_v4(function (product) return (optional_chaining(function () return (product["price"]) end) > 500) end, products)
console_log(string_interpolation("is all product price > 500: ", {is_all_product_price_more_than_500}))
-- is all product price > 500: false

...
if (my_age > 50) then console_log("You are old") end
...
if (my_age < 20) then console_log("You are young") end
...
if (my_age >= 65) then console_log("You are allowed to retire") end
...
if (my_age <= 16) then console_log("You are not allowed to drive") end
...
if ((my_age >= 17) and (has_driving_license == true)) then console_log("You are allowed to drive") else console_log("You are not allowed to drive") end
...
if ((my_age <= 3) or (my_age >= 65)) then console_log("You should stay home") end

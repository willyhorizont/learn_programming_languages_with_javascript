...
-- There's no JavaScript-like Object.entries() in Lua.
-- But, we can create our own function to mimic it in Lua.

console_log("\n-- JavaScript-like Object.entries() in hash-table")
...
console_log(string_interpolation("friend entries: ", json_stringify(object_entries(friend))))

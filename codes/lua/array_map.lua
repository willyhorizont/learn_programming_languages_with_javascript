...
function array_map_v1(callback_function, any_array)
    -- JavaScript-like Array.map() function array_map_v1
    local new_array = {}
    for array_item_index, array_item in ipairs(any_array) do
        local new_array_item = callback_function(array_item, array_item_index, any_array)
        table.insert(new_array, new_array_item)
    end
    return new_array
end

function array_map_v2(callback_function, any_array)
    -- JavaScript-like Array.map() function array_map_v2
    local new_array = {}
    for array_item_index, array_item in ipairs(any_array) do
        table.insert(new_array, callback_function(array_item, array_item_index, any_array))
...
console_log("\n-- JavaScript-like Array.map() in Lua table")
...
numbers_labeled = array_map_v1(function (number) return {[tostring(number)] = ternary(((number % 2) == 0), (function () return "even" end), (function () return "odd" end))} end, numbers)
...
numbers_labeled = array_map_v2(function (number) return {[tostring(number)] = ternary(((number % 2) == 0), (function () return "even" end), (function () return "odd" end))} end, numbers)
console_log(string_interpolation("labeled numbers: ", json_stringify(numbers_labeled, { ["pretty"] = true })))
-- labeled numbers: [
--     {
--         "12": "even"
...
console_log("\n-- JavaScript-like Array.map() in Lua table of hash-tables")
...
products_labeled = array_map_v1(function (product) return spread_object(product, { ["label"] = ternary((optional_chaining(function () return (product["price"]) end) > 100), (function () return "expensive" end), (function () return "cheap" end)) }) end, products)
...
products_labeled = array_map_v2(function (product) return spread_object(product, { ["label"] = ternary((optional_chaining(function () return (product["price"]) end) > 100), (function () return "expensive" end), (function () return "cheap" end)) }) end, products)
console_log(string_interpolation("labeled products: ", json_stringify(products_labeled, { ["pretty"] = true })))
-- labeled products: [
--     {
--         "code": "pasta",

...
console_log("# JavaScript-like Array in Lua (table)")

fruits = {"apple", "mango", "orange"}
console_log(string_interpolation("fruits: ", json_stringify(fruits)))

console_log(string_interpolation("fruits, length: ", {#fruits}))
-- fruits, length: 3

console_log(string_interpolation("fruits, get mango: ", {fruits[2]}))
-- fruits, get mango: "mango"

console_log(string_interpolation("fruits, get mango: ", {optional_chaining(function () return (fruits[2]) end)}))
-- fruits, get mango: "mango"

console_log(string_interpolation("fruits, first element: ", {fruits[1]}))
-- fruits, first element: "apple"

console_log(string_interpolation("fruits, first element: ", {optional_chaining(function () return (fruits[1]) end)}))
-- fruits, first element: "apple"

console_log(string_interpolation("fruits, last element: ", {fruits[#fruits]}))
-- fruits, last element: "orange"

console_log(string_interpolation("fruits, last element: ", {optional_chaining(function () return (fruits[#fruits]) end)}))
-- fruits, last element: "orange"

-- iterate over and print each item and index
for array_item_index, array_item in ipairs(fruits) do
    console_log(string_interpolation("fruits, index: ", {array_item_index}, ", value: ", {array_item}, ", for each loop"))
end
-- fruits, index: 1, value: "apple", for each loop
-- fruits, index: 2, value: "mango", for each loop
-- fruits, index: 3, value: "orange", for each loop

table.insert(fruits, "banana")
console_log(string_interpolation("add item to end, fruits: ", json_stringify(fruits)))

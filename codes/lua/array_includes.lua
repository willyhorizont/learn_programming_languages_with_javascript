...
function array_includes_v1(search_element, any_array)
...
function array_includes_v2(search_element, any_array)
    -- JavaScript-like Array.includes() function array_includes_v2
    for _, array_item in ipairs(any_array) do
        if (array_item == search_element) then return true end
    end
...
console_log(string_interpolation("my friends: ", json_stringify(my_friends)))

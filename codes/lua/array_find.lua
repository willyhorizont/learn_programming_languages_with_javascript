...
function array_find_v1(callback_function, any_array)
...
function array_find_v2(callback_function, any_array)
...
function array_find_v3(callback_function, any_array)
    -- JavaScript-like Array.find() function array_find_v3
    for array_item_index, array_item in ipairs(any_array) do
        local is_condition_match = callback_function(array_item, array_item_index, any_array)
        if (is_condition_match == true) then return array_item end
    end
    return nil
end

function array_find_v4(callback_function, any_array)
    -- JavaScript-like Array.find() function array_find_v4
    for array_item_index, array_item in ipairs(any_array) do
        if (callback_function(array_item, array_item_index, any_array) == true) then return array_item end
    end
...
console_log("\n-- JavaScript-like Array.find() in Lua table")
...
console_log(string_interpolation("odd number found: ", {odd_numbers_found}))
-- odd number found: 27
...
console_log("\n-- JavaScript-like Array.find() in Lua table of hash-tables")
...
product_found = array_find_v1(function (product) return (optional_chaining(function () return (product["code"]) end) == product_to_find) end, products)
...
product_found = array_find_v2(function (product) return (optional_chaining(function () return (product["code"]) end) == product_to_find) end, products)
console_log(string_interpolation("product found: ", json_stringify(product_found, { ["pretty"] = true })))
-- product found: {
--     "code": "bubble_gum",
--     "price": 233
...
product_found = array_find_v3(function (product) return (optional_chaining(function () return (product["code"]) end) == product_to_find) end, products)
console_log(string_interpolation("product found: ", json_stringify(product_found, { ["pretty"] = true })))
-- product found: {
--     "code": "bubble_gum",
--     "price": 233
...
product_found = array_find_v4(function (product) return (optional_chaining(function () return (product["code"]) end) == product_to_find) end, products)
console_log(string_interpolation("product found: ", json_stringify(product_found, { ["pretty"] = true })))
-- product found: {
--     "code": "bubble_gum",
--     "price": 233

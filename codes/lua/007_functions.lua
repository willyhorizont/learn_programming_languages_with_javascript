...
say_hello(function () console_log("how are you?") end)
...
console_log(string_interpolation("optional_chaining(function () return (my_array_of_get_rectangle_area_functions[1](7, 5)) end): ", {optional_chaining(function () return (my_array_of_get_rectangle_area_functions[1](7, 5)) end)}))
console_log(string_interpolation("optional_chaining(function () return (my_array_of_get_rectangle_area_functions[2](7, 5)) end): ", {optional_chaining(function () return (my_array_of_get_rectangle_area_functions[2](7, 5)) end)}))
console_log(string_interpolation("optional_chaining(function () return (my_array_of_get_rectangle_area_functions[3](7, 5)) end): ", {optional_chaining(function () return (my_array_of_get_rectangle_area_functions[3](7, 5)) end)}))
...
console_log(string_interpolation('optional_chaining(function () return (simple_calculator["exponentiation"](2, 4)) end): ', optional_chaining(function () return (simple_calculator["exponentiation"](2, 4)) end)))
console_log(string_interpolation('optional_chaining(function () return (simple_calculator["addition"](9, 3)) end): ', optional_chaining(function () return (simple_calculator["addition"](9, 3)) end)))
console_log(string_interpolation('optional_chaining(function () return (simple_calculator["subtraction"](35, 8)) end): ', optional_chaining(function () return (simple_calculator["subtraction"](35, 8)) end)))
...
multiply_by9_result = multiply_by9(10)
console_log(string_interpolation("multiply_by9(10): ", {multiply_by9_result}))
...
multiply_by10_result = multiply_by10(10)
console_log(string_interpolation("multiply_by10(10): ", {multiply_by10_result}))
...
multiply_by11_result = multiply_by11(10)
console_log(string_interpolation("multiply_by11(10): ", {multiply_by11_result}))
...
multiply_by12_result = multiply_by12(10)
console_log(string_interpolation("multiply_by12(10): ", {multiply_by12_result}))
...
multiply_by13_result = multiply_by13(10)
console_log(string_interpolation("multiply_by13(10): ", {multiply_by13_result}))

multiply_v13 = function (a)
    return function (b) return (a * b) end
end
multiply_by14 = multiply_v13(14)
multiply_by14_result = multiply_by14(10)
console_log(string_interpolation("multiply_by14(10): ", {multiply_by14_result}))

multiply_v14 = function (a) return function (b) return (a * b) end end
multiply_by15 = multiply_v14(15)
multiply_by15_result = multiply_by15(10)
console_log(string_interpolation("multiply_by15(10): ", {multiply_by15_result}))

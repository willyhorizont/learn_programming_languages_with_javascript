...
console_log('-- using JavaScript-like Object.values() function "object_values"')

console_log(string_interpolation("friend values: ", json_stringify(object_values(friend))))

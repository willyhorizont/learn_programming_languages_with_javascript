...
println("\n# JavaScript-like Object.fromEntries() in Julia Dictionary")

friend_entries = Vector{Any}([Vector{Any}(["name", "Alisa"]), Vector{Any}(["country", "Finland"]), Vector{Any}(["age", 25])])
println("friend entries: $(json_stringify(friend_entries, pretty=true))")

println("# using Julia Dictionary comprehension")

println("friend object from friend entries: $(json_stringify(Dict{String, Any}("$(object_key)" => object_value for (object_key, object_value) in friend_entries), pretty=true))")
...
println("# using Julia Object.fromEntries() built-in function \"Dict{String, Any}\"")

println("friend object from friend entries: $(json_stringify(Dict{String, Any}(friend_entries), pretty=true))")
# friend object from friend entries: {
#     "name": "Alisa",
#     "country": "Finland",
#     "age": 25

...
function array_every_v1(callback_function::Any, any_array::Any)::Any
...
function array_every_v2(callback_function::Any, any_array::Any)::Any
...
function array_every_v3(callback_function::Any, any_array::Any)::Any
...
function array_every_v4(callback_function::Any, any_array::Any)::Any
...
is_all_product_price_less_than_500::Any = array_every_v1(((product::Any, _, _) -> ((try product["price"] catch (any_error) nothing end) < 500)::Any), products)
println("is all product price < 500: $(is_all_product_price_less_than_500)")
# is all product price < 500: true

is_all_product_price_more_than_500::Any = array_every_v1(((product::Any, _, _) -> ((try product["price"] catch (any_error) nothing end) > 500)::Any), products)
println("is all product price > 500: $(is_all_product_price_more_than_500)")
# is all product price > 500: false

println("# using JavaScript-like Array.every() function \"array_every_v2\"")

is_all_product_price_less_than_500::Any = array_every_v2(((product::Any, _, _) -> ((try product["price"] catch (any_error) nothing end) < 500)::Any), products)
println("is all product price < 500: $(is_all_product_price_less_than_500)")
# is all product price < 500: true

is_all_product_price_more_than_500::Any = array_every_v2(((product::Any, _, _) -> ((try product["price"] catch (any_error) nothing end) > 500)::Any), products)
println("is all product price > 500: $(is_all_product_price_more_than_500)")
# is all product price > 500: false

println("# using JavaScript-like Array.every() function \"array_every_v3\"")

is_all_product_price_less_than_500::Any = array_every_v3(((product::Any, _, _) -> ((try product["price"] catch (any_error) nothing end) < 500)::Any), products)
println("is all product price < 500: $(is_all_product_price_less_than_500)")
# is all product price < 500: true

is_all_product_price_more_than_500::Any = array_every_v3(((product::Any, _, _) -> ((try product["price"] catch (any_error) nothing end) > 500)::Any), products)
println("is all product price > 500: $(is_all_product_price_more_than_500)")
# is all product price > 500: false

println("# using JavaScript-like Array.every() function \"array_every_v4\"")

is_all_product_price_less_than_500::Any = array_every_v4(((product::Any, _, _) -> ((try product["price"] catch (any_error) nothing end) < 500)::Any), products)
println("is all product price < 500: $(is_all_product_price_less_than_500)")
# is all product price < 500: true

is_all_product_price_more_than_500::Any = array_every_v4(((product::Any, _, _) -> ((try product["price"] catch (any_error) nothing end) > 500)::Any), products)
println("is all product price > 500: $(is_all_product_price_more_than_500)")
# is all product price > 500: false

println("# using Julia Array.every() built-in function \"all\"")

is_all_product_price_less_than_500::Any = all(((product::Any) -> ((try product["price"] catch (any_error) nothing end) < 500)::Any), products)
println("is all product price < 500: $(is_all_product_price_less_than_500)")
# is all product price < 500: true

is_all_product_price_more_than_500::Any = all(((product::Any) -> ((try product["price"] catch (any_error) nothing end) > 500)::Any), products)
println("is all product price > 500: $(is_all_product_price_more_than_500)")
# is all product price > 500: false

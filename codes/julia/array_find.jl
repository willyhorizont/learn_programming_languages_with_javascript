...
function array_find_v5(callback_function, an_array)
    ...
    data_found_index::Any = findfirst(callback_function, an_array)
...
even_number_found::Any = array_find_v1((number, _, _) -> ((number % 2) === 0), numbers)
println("even number found: ", even_number_found)
# even number found: 12

odd_numbers_found::Any = array_find_v1((number, _, _) -> ((number % 2) !== 0), numbers)
println("odd number found: ", odd_numbers_found)
# odd number found: 27

println("# using JavaScript-like Array.find() function \"array_find_v2\"")

even_number_found::Any = array_find_v2((number, _, _) -> ((number % 2) === 0), numbers)
println("even number found: ", even_number_found)
# even number found: 12

odd_numbers_found::Any = array_find_v2((number, _, _) -> ((number % 2) !== 0), numbers)
println("odd number found: ", odd_numbers_found)
# odd number found: 27

println("# using JavaScript-like Array.find() function \"array_find_v3\"")

even_number_found::Any = array_find_v3((number, _, _) -> ((number % 2) === 0), numbers)
println("even number found: ", even_number_found)
# even number found: 12

odd_numbers_found::Any = array_find_v3((number, _, _) -> ((number % 2) !== 0), numbers)
println("odd number found: ", odd_numbers_found)
# odd number found: 27

println("# using JavaScript-like Array.find() function \"array_find_v4\"")

even_number_found::Any = array_find_v4((number, _, _) -> ((number % 2) === 0), numbers)
println("even number found: ", even_number_found)
# even number found: 12

odd_numbers_found::Any = array_find_v4((number, _, _) -> ((number % 2) !== 0), numbers)
println("odd number found: ", odd_numbers_found)
# odd number found: 27

println("# using JavaScript-like Array.find() function \"array_find_v5\"")

even_number_found::Any = array_find_v5((number) -> ((number % 2) === 0), numbers)
println("even number found: ", even_number_found)
# even number found: 12

odd_numbers_found::Any = array_find_v5((number) -> ((number % 2) !== 0), numbers)
println("odd number found: ", odd_numbers_found)
# odd number found: 27
...
product_found::Any = array_find_v1((product, _, _) -> (product["code"] === product_to_find), products)
...
product_found::Any = array_find_v2((product, _, _) -> (product["code"] === product_to_find), products)
println("product found: ", json_stringify(product_found, pretty=true))
# product found: {
#     "code": "bubble_gum",
#     "price": 233
...
product_found::Any = array_find_v3((product, _, _) -> (product["code"] === product_to_find), products)
println("product found: ", json_stringify(product_found, pretty=true))
# product found: {
#     "code": "bubble_gum",
#     "price": 233
...
product_found::Any = array_find_v4((product, _, _) -> (product["code"] === product_to_find), products)
println("product found: ", json_stringify(product_found, pretty=true))
# product found: {
#     "code": "bubble_gum",
#     "price": 233
...
product_found::Any = array_find_v5((product) -> (product["code"] === product_to_find), products)
println("product found: ", json_stringify(product_found, pretty=true))
# product found: {
#     "code": "bubble_gum",
#     "price": 233

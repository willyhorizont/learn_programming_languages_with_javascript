...
println("# using Julia Vector comprehension and Julia built-in function \"pairs\"")

println("friend entries: $(json_stringify(Vector{Any}([Vector{Any}([object_key, object_value]) for (object_key, object_value) in pairs(friend)])))")
# friend entries: [["name", "Alisa"], ["country", "Finland"], ["age", 25]]

println("# using Julia Vector comprehension")

println("friend entries: $(json_stringify(Vector{Any}([Vector{Any}([object_key, object_value]) for (object_key, object_value) in friend])))")
# friend entries: [["name", "Alisa"], ["country", "Finland"], ["age", 25]]

println("# using JavaScript-like Object.entries() function \"object_entries\"")

println("friend entries: $(json_stringify(Vector{Any}(object_entries(friend))))")
# friend entries: [["name", "Alisa"], ["country", "Finland"], ["age", 25]]

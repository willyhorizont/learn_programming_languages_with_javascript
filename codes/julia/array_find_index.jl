...
number_found_index::Any = array_find_index_v1((number, _, _) -> (number === number_to_find), numbers)
...
number_found_index::Any = array_find_index_v2((number, _, _) -> (number === number_to_find), numbers)
println("number found index: ", number_found_index)
# number found index: 3

println("# using JavaScript-like Array.findIndex() function \"array_find_index_v3\"")

number_found_index::Any = array_find_index_v3((number, _, _) -> (number === number_to_find), numbers)
println("number found index: ", number_found_index)
# number found index: 3

println("# using JavaScript-like Array.findIndex() function \"array_find_index_v4\"")

number_found_index::Any = array_find_index_v4((number, _, _) -> (number === number_to_find), numbers)
println("number found index: ", number_found_index)
# number found index: 3

println("# using Julia Array.findIndex() built-in function \"findfirst\"")

number_found_index::Any = findfirst((number) -> (number === number_to_find), numbers)
println("number found index: ", number_found_index)
# number found index: 3
...
product_found_index::Any = array_find_index_v1((product, _, _) -> (product["code"] === product_to_find), products)
println("product found index: ", product_found_index)
# product found index: 1

println("# using JavaScript-like Array.findIndex() function \"array_find_index_v2\"")

product_found_index::Any = array_find_index_v2((product, _, _) -> (product["code"] === product_to_find), products)
println("product found index: ", product_found_index)
# product found index: 1

println("# using JavaScript-like Array.findIndex() function \"array_find_index_v3\"")

product_found_index::Any = array_find_index_v3((product, _, _) -> (product["code"] === product_to_find), products)
println("product found index: ", product_found_index)
# product found index: 1

println("# using JavaScript-like Array.findIndex() function \"array_find_index_v4\"")

product_found_index::Any = array_find_index_v4((product, _, _) -> (product["code"] === product_to_find), products)
println("product found index: ", product_found_index)
# product found index: 1

println("# using Julia Array.findIndex() built-in function \"findfirst\"")

product_found_index::Any = findfirst((product) -> (product["code"] === product_to_find), products)
println("product found index: ", product_found_index)
# product found index: 1

...
array_some_v1::Any = (callback_function::Any, an_array::Any) -> (begin
...
array_some_v2::Any = (callback_function::Any, an_array::Any) -> (begin
...
array_some_v3::Any = (callback_function::Any, an_array::Any) -> (begin
...
array_some_v4::Any = (callback_function::Any, an_array::Any) -> (begin
    # JavaScript-like Array.some() function array_some_v4
    for (array_item_index, array_item) in enumerate(an_array)
        if (callback_function(array_item, array_item_index, an_array) === true) return true end
    end
    return false
end)::Any
...
is_any_product_price_less_than_500::Any = array_some_v1(((product::Any, _, _) -> ((try product["price"] catch (e) nothing end) < 500)::Any), products)
println("is any product price < 500: $(is_any_product_price_less_than_500)")
# is any product price < 500: true

is_any_product_price_more_than_500::Any = array_some_v1(((product::Any, _, _) -> ((try product["price"] catch (e) nothing end) > 500)::Any), products)
println("is any product price > 500: $(is_any_product_price_more_than_500)")
# is any product price > 500: false

println("# using JavaScript-like Array.some() function \"array_some_v2\"")

is_any_product_price_less_than_500::Any = array_some_v2(((product::Any, _, _) -> ((try product["price"] catch (e) nothing end) < 500)::Any), products)
println("is any product price < 500: $(is_any_product_price_less_than_500)")
# is any product price < 500: true

is_any_product_price_more_than_500::Any = array_some_v2(((product::Any, _, _) -> ((try product["price"] catch (e) nothing end) > 500)::Any), products)
println("is any product price > 500: $(is_any_product_price_more_than_500)")
# is any product price > 500: false

println("# using JavaScript-like Array.some() function \"array_some_v3\"")

is_any_product_price_less_than_500::Any = array_some_v3(((product::Any, _, _) -> ((try product["price"] catch (e) nothing end) < 500)::Any), products)
println("is any product price < 500: $(is_any_product_price_less_than_500)")
# is any product price < 500: true

is_any_product_price_more_than_500::Any = array_some_v3(((product::Any, _, _) -> ((try product["price"] catch (e) nothing end) > 500)::Any), products)
println("is any product price > 500: $(is_any_product_price_more_than_500)")
# is any product price > 500: false

println("# using JavaScript-like Array.some() function \"array_some_v4\"")

is_any_product_price_less_than_500::Any = array_some_v4(((product::Any, _, _) -> ((try product["price"] catch (e) nothing end) < 500)::Any), products)
println("is any product price < 500: $(is_any_product_price_less_than_500)")
# is any product price < 500: true

is_any_product_price_more_than_500::Any = array_some_v4(((product::Any, _, _) -> ((try product["price"] catch (e) nothing end) > 500)::Any), products)
println("is any product price > 500: $(is_any_product_price_more_than_500)")
# is any product price > 500: false

println("# using Julia Array.some() built-in function \"any\"")

is_any_product_price_less_than_500::Any = any([((try product["price"] catch (e) nothing end) < 500)::Any for product in products])
println("is any product price < 500: $(is_any_product_price_less_than_500)")
# is any product price < 500: true

is_any_product_price_more_than_500::Any = any([((try product["price"] catch (e) nothing end) > 500)::Any for product in products])
println("is any product price > 500: $(is_any_product_price_more_than_500)")
# is any product price > 500: false

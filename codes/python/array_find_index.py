...
def array_find_index_v1(callback_function, any_array):
...
def array_find_index_v2(callback_function, any_array):
...
def array_find_index_v3(callback_function, any_array):
...
def array_find_index_v4(callback_function, any_array):
...
product_found_index = array_find_index_v1(lambda any_product, *_: (optional_chaining(lambda: any_product["code"]) == product_to_find), products)
print(f"product found index: {product_found_index}")
# product found index: 0

print('# using JavaScript-like Array.findIndex() function "array_find_index_v2"')

product_found_index = array_find_index_v2(lambda any_product, *_: (optional_chaining(lambda: any_product["code"]) == product_to_find), products)
print(f"product found index: {product_found_index}")
# product found index: 0

print('# using JavaScript-like Array.findIndex() function "array_find_index_v3"')

product_found_index = array_find_index_v3(lambda any_product, *_: (optional_chaining(lambda: any_product["code"]) == product_to_find), products)
print(f"product found index: {product_found_index}")
# product found index: 0

print('# using JavaScript-like Array.findIndex() function "array_find_index_v4"')

product_found_index = array_find_index_v4(lambda any_product, *_: (optional_chaining(lambda: any_product["code"]) == product_to_find), products)
print(f"product found index: {product_found_index}")
# product found index: 0

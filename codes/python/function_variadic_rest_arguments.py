...
print("# Variadic Function Rest Arguments in Python")


def function_v1_variadic(*rest_arguments):
    print(f'function v1 variadic rest arguments: {json_stringify(rest_arguments)}')


function_v1_variadic(1, 2, 3, 4)

function_v2_variadic = lambda *rest_arguments: print(f'function v2 variadic rest arguments: {json_stringify(rest_arguments)}')

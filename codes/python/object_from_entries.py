...
print("\n# JavaScript-like Object.fromEntries() in Python dictionary")

friend_entries = [["name", "Alisa"], ["country", "Finland"], ["age", 25]]
print(f"friend entries: {json_stringify(friend_entries, pretty=True)}")

print("# using Python dictionary comprehension")

print(f"friend object from friend entries: {json_stringify({object_key: object_value for object_key, object_value in friend_entries}, pretty=True)}")
...
print('# using Python Object.fromEntries() built-in function "dict"')

print(f"friend object from friend entries: {json_stringify(dict(friend_entries), pretty=True)}")
# friend object from friend entries: {
#     "name": "Alisa",
#     "country": "Finland",
#     "age": 25

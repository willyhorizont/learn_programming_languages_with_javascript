...
is_any_product_price_less_than_500 = array_some_v1(lambda any_product, *_: (optional_chaining(lambda: any_product["price"]) < 500), products)
print(f"is any product price < 500: {is_any_product_price_less_than_500}")
# is any product price < 500: True

is_any_product_price_more_than_500 = array_some_v1(lambda any_product, *_: (optional_chaining(lambda: any_product["price"]) > 500), products)
...
is_any_product_price_less_than_500 = array_some_v2(lambda any_product, *_: (optional_chaining(lambda: any_product["price"]) < 500), products)
print(f"is any product price < 500: {is_any_product_price_less_than_500}")
# is any product price < 500: True

is_any_product_price_more_than_500 = array_some_v2(lambda any_product, *_: (optional_chaining(lambda: any_product["price"]) > 500), products)
print(f"is any product price > 500: {is_any_product_price_more_than_500}")
# is any product price > 500: False

print('# using JavaScript-like Array.every() function "array_some_v3"')

is_any_product_price_less_than_500 = array_some_v3(lambda any_product, *_: (optional_chaining(lambda: any_product["price"]) < 500), products)
print(f"is any product price < 500: {is_any_product_price_less_than_500}")
# is any product price < 500: True

is_any_product_price_more_than_500 = array_some_v3(lambda any_product, *_: (optional_chaining(lambda: any_product["price"]) > 500), products)
print(f"is any product price > 500: {is_any_product_price_more_than_500}")
# is any product price > 500: False

print('# using JavaScript-like Array.every() function "array_some_v4"')

is_any_product_price_less_than_500 = array_some_v4(lambda any_product, *_: (optional_chaining(lambda: any_product["price"]) < 500), products)
print(f"is any product price < 500: {is_any_product_price_less_than_500}")
# is any product price < 500: True

is_any_product_price_more_than_500 = array_some_v4(lambda any_product, *_: (optional_chaining(lambda: any_product["price"]) > 500), products)
print(f"is any product price > 500: {is_any_product_price_more_than_500}")
# is any product price > 500: False

print('# using Python Array.some() built-in function "any", the "pythonic" way')

is_any_product_price_less_than_500 = any([(optional_chaining(lambda: any_product["price"]) < 500) for any_product in products])
print(f"is any product price < 500: {is_any_product_price_less_than_500}")
# is any product price < 500: True

is_any_product_price_more_than_500 = any([(optional_chaining(lambda: any_product["price"]) > 500) for any_product in products])
print(f"is any product price > 500: {is_any_product_price_more_than_500}")
# is any product price > 500: False

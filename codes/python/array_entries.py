...
print("\n# JavaScript-like Array.entries() in Python list")

fruits = ["apple", "banana", "cherry"]
print(f"fruits: {json_stringify(fruits, pretty=True)}")

print("# using Python dictionary comprehension")

print(f"fruits entries: {json_stringify({array_item_index: array_item for (array_item_index, array_item) in enumerate(fruits)}, pretty=True)}")
# fruits entries: {
#     "0": "apple",
#     "1": "banana",
#     "2": "cherry"
...
print('# using Python Array.entries() built-in function "dict(enumerate)"')

print(f"fruits entries: {json_stringify(dict(enumerate(fruits)), pretty=True)}")
# fruits entries: {
#     "0": "apple",
#     "1": "banana",
#     "2": "cherry"

...
for (@products1.kv) -> $array-item-index, $array-item {
    for ($array-item.pairs.kv) -> $object-entry-index, $object-entry {
        my $object-key = $object-entry.key;
        my $object-value = $object-entry.value;
        print("products1, for loop, array item index: {$array-item-index}, object iteration/entry index: {$object-entry-index}, key: {$object-key}, value: {$object-value}", "\n");
    }
}
...
for (@products2.kv) -> $array-item-index, $array-item {
    for ($array-item.pairs.kv) -> $object-entry-index, $object-entry {
        my $object-key = $object-entry.key;
        my $object-value = $object-entry.value;
        print("products2, for loop, array item index: {$array-item-index}, object iteration/entry index: {$object-entry-index}, key: {$object-key}, value: {$object-value}", "\n");
    }
}
...
for ($products3.kv) -> $array-item-index, $array-item {
    for ($array-item.pairs.kv) -> $object-entry-index, $object-entry {
        my $object-key = $object-entry.key;
        my $object-value = $object-entry.value;
        print("products3, for loop, array item index: {$array-item-index}, object iteration/entry index: {$object-entry-index}, key: {$object-key}, value: {$object-value}", "\n");
    }
}
# products3, for loop, array item index: 0, object iteration/entry index: 0, key: id, value: P1
# products3, for loop, array item index: 0, object iteration/entry index: 1, key: name, value: bubble gum
# products3, for loop, array item index: 1, object iteration/entry index: 0, key: id, value: P2
# products3, for loop, array item index: 1, object iteration/entry index: 1, key: name, value: potato chips
...
for ($products4.kv) -> $array-item-index, $array-item {
    for ($array-item.pairs.kv) -> $object-entry-index, $object-entry {
        my $object-key = $object-entry.key;
        my $object-value = $object-entry.value;
        print("products4, for loop, array item index: {$array-item-index}, object iteration/entry index: {$object-entry-index}, key: {$object-key}, value: {$object-value}", "\n");
    }
}
...
for ($products5.kv) -> $array-item-index, $array-item {
    for ($array-item.pairs.kv) -> $object-entry-index, $object-entry {
        my $object-key = $object-entry.key;
        my $object-value = $object-entry.value;
        print("products5, for loop, array item index: {$array-item-index}, object iteration/entry index: {$object-entry-index}, key: {$object-key}, value: {$object-value}", "\n");
    }
}
# products5, for loop, array item index: 0, object iteration/entry index: 0, key: id, value: P1
# products5, for loop, array item index: 0, object iteration/entry index: 1, key: name, value: bubble gum
# products5, for loop, array item index: 1, object iteration/entry index: 0, key: id, value: P2
# products5, for loop, array item index: 1, object iteration/entry index: 1, key: name, value: potato chips

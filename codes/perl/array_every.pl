...
sub array_every_v1 {
    ...
    for (my $array_item_index = 0; ($array_item_index < scalar(@{$an_array_ref})); $array_item_index += 1) {
        ...
        last if ($is_condition_match eq "false");
    }
...
sub array_every_v2 {
    ...
    for (my $array_item_index = 0; ($array_item_index < scalar(@{$an_array_ref})); $array_item_index += 1) {
        my $array_item = $an_array_ref->[$array_item_index];
        $is_condition_match = boolean($callback_function_ref->($array_item, $array_item_index, $an_array_ref));
        return $is_condition_match if ($is_condition_match eq "false");
    }
    return $is_condition_match;
}
...
sub array_every_v3 {
    ...
    for (my $array_item_index = 0; ($array_item_index < scalar(@{$an_array_ref})); $array_item_index += 1) {
        ...
        return "false" if ($is_condition_match eq "false");
    }
    return "true";
}
...
sub array_every_v4 {
    ...
    for (my $array_item_index = 0; ($array_item_index < scalar(@{$an_array_ref})); $array_item_index += 1) {
        my $array_item = $an_array_ref->[$array_item_index];
        return "false" if ((boolean($callback_function_ref->($array_item, $array_item_index, $an_array_ref))) eq "false");
    }
    return "true";
}
...
{
    my $is_all_number_less_than_500 = array_every_v1(sub { ([@_]->[0] < 500) }, $numbers_ref);
    console_log(string_interpolation("is all number < 500: ", [$is_all_number_less_than_500]));
    # is all number < 500: true

    my $is_all_number_more_than_500 = array_every_v1(sub { ([@_]->[0] > 500) }, $numbers_ref);
...
{
    my $is_all_number_less_than_500 = array_every_v2(sub { ([@_]->[0] < 500) }, $numbers_ref);
    console_log(string_interpolation("is all number < 500: ", [$is_all_number_less_than_500]));
    # is all number < 500: true

    my $is_all_number_more_than_500 = array_every_v2(sub { ([@_]->[0] > 500) }, $numbers_ref);
    console_log(string_interpolation("is all number > 500: ", [$is_all_number_more_than_500]));
    # is all number > 500: false
}
...
{
    my $is_all_number_less_than_500 = array_every_v3(sub { ([@_]->[0] < 500) }, $numbers_ref);
    console_log(string_interpolation("is all number < 500: ", [$is_all_number_less_than_500]));
    # is all number < 500: true

    my $is_all_number_more_than_500 = array_every_v3(sub { ([@_]->[0] > 500) }, $numbers_ref);
    console_log(string_interpolation("is all number > 500: ", [$is_all_number_more_than_500]));
    # is all number > 500: false
}
...
{
    my $is_all_number_less_than_500 = array_every_v4(sub { ([@_]->[0] < 500) }, $numbers_ref);
    console_log(string_interpolation("is all number < 500: ", [$is_all_number_less_than_500]));
    # is all number < 500: true

    my $is_all_number_more_than_500 = array_every_v4(sub { ([@_]->[0] > 500) }, $numbers_ref);
    console_log(string_interpolation("is all number > 500: ", [$is_all_number_more_than_500]));
    # is all number > 500: false
}
...
{
    my $is_all_number_less_than_500 = boolean(all { ([@_]->[0] < 500) } @{$numbers_ref});
    console_log(string_interpolation("is all number < 500: ", [$is_all_number_less_than_500]));
    # is all number < 500: true

    my $is_all_number_more_than_500 = boolean(all { ([@_]->[0] > 500) } @{$numbers_ref});
    console_log(string_interpolation("is all number > 500: ", [$is_all_number_more_than_500]));
    # is all number > 500: false
}

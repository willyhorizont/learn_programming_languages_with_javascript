...
console_log(string_interpolation("friend entries: ", json_stringify(\@{$friend_entries_ref}, "pretty" => "true")));
console_log(string_interpolation("friend entries: ", json_stringify($friend_entries_ref, "pretty" => "true")));

console_log(string_interpolation('# using JavaScript-like Object.fromEntries() function "object_from_entries"'));

console_log(string_interpolation("friend object from friend entries: ", json_stringify(\%{object_from_entries($friend_entries_ref)}, "pretty" => "true")));
console_log(string_interpolation("friend object from friend entries: ", json_stringify(object_from_entries($friend_entries_ref), "pretty" => "true")));
# friend object from friend entries: {
#     "name": "Alisa",
#     "country": "Finland",

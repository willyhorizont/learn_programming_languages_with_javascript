...
console_log(string_interpolation('json_stringify($my_array_ref, "pretty" => "true"): ', json_stringify($my_array_ref, "pretty" => "true")));
my %my_object = (
    "my_function" => sub {
        my ($a, $b) = @_;
        return ($a * $b);
...
console_log(string_interpolation('json_stringify($my_object_ref, "pretty" => "true"): ', json_stringify($my_object_ref, "pretty" => "true")));

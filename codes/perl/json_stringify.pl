...
console_log("# JavaScript-like JSON.stringify() in Perl");
...
console_log(string_interpolation('json_stringify([@my_array]): ', json_stringify([@my_array])));
console_log(string_interpolation('json_stringify(\@my_array, "pretty" => (1 == 1)): ', json_stringify(\@my_array, "pretty" => (1 == 1))));
console_log(string_interpolation('json_stringify([@my_array], "pretty" => (1 == 1)): ', json_stringify([@my_array], "pretty" => (1 == 1))));
my $my_array_ref = [
    sub {
        my ($a, $b) = @_;
...
console_log(string_interpolation('json_stringify($my_array_ref): ', json_stringify($my_array_ref)));
console_log(string_interpolation('json_stringify($my_array_ref, "pretty" => (1 == 1)): ', json_stringify($my_array_ref, "pretty" => (1 == 1))));
my %my_object = (
    "my_function" => sub {
        my ($a, $b) = @_;
        return ($a * $b);
...
console_log(string_interpolation('json_stringify({%my_object}): ', json_stringify({%my_object})));
console_log(string_interpolation('json_stringify(\%my_object, "pretty" => (1 == 1)): ', json_stringify(\%my_object, "pretty" => (1 == 1))));
console_log(string_interpolation('json_stringify({%my_object}, "pretty" => (1 == 1)): ', json_stringify({%my_object}, "pretty" => (1 == 1))));
my $my_object_ref = {
    "my_function" => sub {
        my ($a, $b) = @_;
...
console_log(string_interpolation('json_stringify($my_object_ref): ', json_stringify($my_object_ref)));
console_log(string_interpolation('json_stringify($my_object_ref, "pretty" => (1 == 1)): ', json_stringify($my_object_ref, "pretty" => (1 == 1))));

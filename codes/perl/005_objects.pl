...
console_log(string_interpolation("delivery_response: ", json_stringify(\%delivery_response, "pretty" => (1 == 1))));
console_log(string_interpolation("delivery_response: ", json_stringify({%delivery_response}, "pretty" => (1 == 1))));
...
console_log(string_interpolation("delivery_response_ref: ", json_stringify(\%{$delivery_response_ref}, "pretty" => (1 == 1))));
console_log(string_interpolation("delivery_response_ref: ", json_stringify($delivery_response_ref, "pretty" => (1 == 1))));

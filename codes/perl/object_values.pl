...
console_log(string_interpolation("friend values: ", [\@{[values(%friend)]}]));
console_log(string_interpolation("friend values: ", [[values(%friend)]]));
...
console_log(string_interpolation("friend values: ", [\@{[values(%{$friend_ref})]}]));
console_log(string_interpolation("friend values: ", [[values(%{$friend_ref})]]));
# friend_ref values: ["Alisa", "Finland", 25]

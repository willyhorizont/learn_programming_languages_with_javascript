...
our $xxx = "global_scope, 01";
my $yyy = "global_scope, 02";
console_log(string_interpolation("xxx: ", $xxx)); # xxx: global_scope, 01
console_log(string_interpolation("yyy: ", $yyy)); # yyy: global_scope, 02

# local scope: function scope, block scope ({}, if{}, for{}, while{})

our $xxx = "global_scope, 1"; # doesn't throw error when redefined !
my $yyy = "global_scope, 2"; # doesn't throw error when redefined !
# local scope block scope {}
{
    our $xxx = "local_scope_block_scope {}, 10"; # doesn't throw error when redefined !
    my $yyy = "local_scope_block_scope {}, 20";
    my $aaa = "local_scope_block_scope {}, 30";
    console_log(string_interpolation("xxx: ", $xxx)); # xxx: local_scope_block_scope {}, 10
    console_log(string_interpolation("yyy: ", $yyy)); # yyy: local_scope_block_scope {}, 20
    console_log(string_interpolation("aaa: ", $aaa)); # aaa: local_scope_block_scope {}, 30
}
console_log(string_interpolation("xxx: ", $xxx)); # xxx: local_scope_block_scope {}, 10
console_log(string_interpolation("yyy: ", $yyy)); # yyy: global_scope, 2
...
if ("true") {
    our $xxx = "local_scope_block_scope if{}, 10"; # doesn't throw error when redefined !
    my $yyy = "local_scope_block_scope if{}, 20";
    my $aaa = "local_scope_block_scope if{}, 30";
    console_log(string_interpolation("xxx: ", $xxx)); # xxx: local_scope_block_scope if{}, 10
    console_log(string_interpolation("yyy: ", $yyy)); # yyy: local_scope_block_scope if{}, 20
    console_log(string_interpolation("aaa: ", $aaa)); # aaa: local_scope_block_scope if{}, 30
}
console_log(string_interpolation("xxx: ", $xxx)); # xxx: local_scope_block_scope if{}, 10
console_log(string_interpolation("yyy: ", $yyy)); # yyy: global_scope, 2
# console_log(string_interpolation("aaa: ", $aaa)); # "aaa" is not defined
...
for (my $i = 0; ($i < 1); $i += 1) {
    our $xxx = "local_scope_block_scope for{}, 10"; # doesn't throw error when redefined !
    my $yyy = "local_scope_block_scope for{}, 20";
    my $aaa = "local_scope_block_scope for{}, 30";
    console_log(string_interpolation("xxx: ", $xxx)); # xxx: local_scope_block_scope for{}, 10
    console_log(string_interpolation("yyy: ", $yyy)); # yyy: local_scope_block_scope for{}, 20
    console_log(string_interpolation("aaa: ", $aaa)); # aaa: local_scope_block_scope for{}, 30
}
console_log(string_interpolation("xxx: ", $xxx)); # xxx: local_scope_block_scope for{}, 10
console_log(string_interpolation("yyy: ", $yyy)); # yyy: global_scope, 2
# console_log(string_interpolation("aaa: ", $aaa)); # "aaa" is not defined
...
while ("true") {
    our $xxx = "local_scope_block_scope while{}, 10"; # doesn't throw error when redefined !
    my $yyy = "local_scope_block_scope while{}, 20";
    my $aaa = "local_scope_block_scope while{}, 30";
    console_log(string_interpolation("xxx: ", $xxx)); # xxx: local_scope_block_scope while{}, 10
    console_log(string_interpolation("yyy: ", $yyy)); # yyy: local_scope_block_scope while{}, 20
    console_log(string_interpolation("aaa: ", $aaa)); # aaa: local_scope_block_scope while{}, 30
    last;
}
console_log(string_interpolation("xxx: ", $xxx)); # xxx: local_scope_block_scope while{}, 10
console_log(string_interpolation("yyy: ", $yyy)); # yyy: global_scope, 2
...
our $xxx = "global_scope, 1"; # doesn't throw error when redefined !
my $yyy = "global_scope, 2"; # doesn't throw error when redefined !
# local scope function scope sub{}
(sub {
    our $xxx = "local_scope_function_scope sub{}, 100"; # doesn't throw error when redefined !
    my $yyy = "local_scope_function_scope sub{}, 200";
    my $aaa = "local_scope_function_scope sub{}, 300";
    console_log(string_interpolation("xxx: ", $xxx)); # xxx: local_scope_function_scope sub{}, 100
    console_log(string_interpolation("yyy: ", $yyy)); # yyy: local_scope_function_scope sub{}, 200
    console_log(string_interpolation("aaa: ", $aaa)); # aaa: local_scope_function_scope sub{}, 300
})->();
console_log(string_interpolation("xxx: ", $xxx)); # xxx: local_scope_function_scope sub{}, 100
console_log(string_interpolation("yyy: ", $yyy)); # yyy: global_scope, 2
# console_log(string_interpolation("aaa: ", $aaa)); # "aaa" is not defined

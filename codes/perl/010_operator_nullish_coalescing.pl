...
console_log("\n# JavaScript-like Nullish Coalescing Operator (??) in Perl (Logical Defined-Or (//))");
...
console_log(string_interpolation("JSON_OBJECT: ", json_stringify(\%JSON_OBJECT, "pretty" => (1 == 1))));
console_log(string_interpolation("JSON_OBJECT: ", json_stringify({%JSON_OBJECT}, "pretty" => (1 == 1))));

console_log(string_interpolation('(JSON_OBJECT?.foo?.bar or JSON_OBJECT?.["foo"]?.["bar"] ?? "not found"): ', json_stringify((optional_chaining({%JSON_OBJECT}, "foo", "bar") // "not found"))));
# (JSON_OBJECT?.foo?.bar or JSON_OBJECT?.["foo"]?.["bar"] ?? "not found"): "baz"

console_log(string_interpolation('(JSON_OBJECT?.foo?.baz or JSON_OBJECT?.["foo"]?.["baz"] ?? "not found"): ', json_stringify((optional_chaining({%JSON_OBJECT}, "foo", "baz") // "not found"))));
# (JSON_OBJECT?.foo?.baz or JSON_OBJECT?.["foo"]?.["baz"] ?? "not found"): null

console_log(string_interpolation('(JSON_OBJECT?.fruits?.[2] or JSON_OBJECT?.["fruits"]?.[2] ?? "not found"): ', json_stringify((optional_chaining({%JSON_OBJECT}, "fruits", 2) // "not found"))));
# (JSON_OBJECT?.fruits?.[2] or JSON_OBJECT?.["fruits"]?.[2] ?? "not found"): "banana"

console_log(string_interpolation('(JSON_OBJECT?.fruits?.[5] or JSON_OBJECT?.["fruits"]?.[5] ?? "not found"): ', json_stringify((optional_chaining({%JSON_OBJECT}, "fruits", 5) // "not found"))));
# (JSON_OBJECT?.fruits?.[5] or JSON_OBJECT?.["fruits"]?.[5] ?? "not found"): null

console_log(string_interpolation('(JSON_OBJECT?.get_rectangle_area?.(7, 5) or JSON_OBJECT?.["get_rectangle_area"]?.(7, 5) ?? "not found"): ', json_stringify((optional_chaining(optional_chaining({%JSON_OBJECT}, "get_rectangle_area"), 7, 5) // "not found"))));
# (JSON_OBJECT?.get_rectangle_area?.(7, 5) or JSON_OBJECT?.["get_rectangle_area"]?.(7, 5) ?? "not found"): 35

console_log(string_interpolation('(JSON_OBJECT?.get_circle_area?.(7) or JSON_OBJECT?.["get_circle_area"]?.(7) ?? "not found"): ', json_stringify((optional_chaining(optional_chaining({%JSON_OBJECT}, "get_circle_area"), 7) // "not found"))));
# (JSON_OBJECT?.get_circle_area?.(7) or JSON_OBJECT?.["get_circle_area"]?.(7) ?? "not found"): null

console_log(string_interpolation('(JSON_OBJECT?.get_rectangle_area?.(7, 5) or JSON_OBJECT?.["get_rectangle_area"]?.(7, 5) ?? "not found"): ', json_stringify((pipe_v2(optional_chaining({%JSON_OBJECT}, "get_rectangle_area"), sub { optional_chaining([@_]->[0], 7, 5) }) // "not found"))));
# (JSON_OBJECT?.get_rectangle_area?.(7, 5) or JSON_OBJECT?.["get_rectangle_area"]?.(7, 5) ?? "not found"): 35

console_log(string_interpolation('(JSON_OBJECT?.get_circle_area?.(7) or JSON_OBJECT?.["get_circle_area"]?.(7) ?? "not found"): ', json_stringify((pipe_v2(optional_chaining({%JSON_OBJECT}, "get_circle_area"), sub { optional_chaining([@_]->[0], 7) }) // "not found"))));
# (JSON_OBJECT?.get_circle_area?.(7) or JSON_OBJECT?.["get_circle_area"]?.(7) ?? "not found"): null
...
console_log(string_interpolation("JSON_OBJECT: ", json_stringify(\%{$JSON_OBJECT_ref}, "pretty" => (1 == 1))));
console_log(string_interpolation("JSON_OBJECT: ", json_stringify($JSON_OBJECT_ref, "pretty" => (1 == 1))));

console_log(string_interpolation('(JSON_OBJECT?.foo?.bar or JSON_OBJECT?.["foo"]?.["bar"] ?? "not found"): ', json_stringify((optional_chaining($JSON_OBJECT_ref, "foo", "bar") // "not found"))));
# (JSON_OBJECT?.foo?.bar or JSON_OBJECT?.["foo"]?.["bar"] ?? "not found"): "baz"

console_log(string_interpolation('(JSON_OBJECT?.foo?.baz or JSON_OBJECT?.["foo"]?.["baz"] ?? "not found"): ', json_stringify((optional_chaining($JSON_OBJECT_ref, "foo", "baz") // "not found"))));
# (JSON_OBJECT?.foo?.baz or JSON_OBJECT?.["foo"]?.["baz"] ?? "not found"): null

console_log(string_interpolation('(JSON_OBJECT?.fruits?.[2] or JSON_OBJECT?.["fruits"]?.[2] ?? "not found"): ', json_stringify((optional_chaining($JSON_OBJECT_ref, "fruits", 2) // "not found"))));
# (JSON_OBJECT?.fruits?.[2] or JSON_OBJECT?.["fruits"]?.[2] ?? "not found"): "banana"

console_log(string_interpolation('(JSON_OBJECT?.fruits?.[5] or JSON_OBJECT?.["fruits"]?.[5] ?? "not found"): ', json_stringify((optional_chaining($JSON_OBJECT_ref, "fruits", 5) // "not found"))));
# (JSON_OBJECT?.fruits?.[5] or JSON_OBJECT?.["fruits"]?.[5] ?? "not found"): null

console_log(string_interpolation('(JSON_OBJECT?.get_rectangle_area?.(7, 5) or JSON_OBJECT?.["get_rectangle_area"]?.(7, 5) ?? "not found"): ', json_stringify((optional_chaining(optional_chaining($JSON_OBJECT_ref, "get_rectangle_area"), 7, 5) // "not found"))));
# (JSON_OBJECT?.get_rectangle_area?.(7, 5) or JSON_OBJECT?.["get_rectangle_area"]?.(7, 5) ?? "not found"): 35

console_log(string_interpolation('(JSON_OBJECT?.get_circle_area?.(7) or JSON_OBJECT?.["get_circle_area"]?.(7) ?? "not found"): ', json_stringify((optional_chaining(optional_chaining($JSON_OBJECT_ref, "get_circle_area"), 7) // "not found"))));
# (JSON_OBJECT?.get_circle_area?.(7) or JSON_OBJECT?.["get_circle_area"]?.(7) ?? "not found"): null

console_log(string_interpolation('(JSON_OBJECT?.get_rectangle_area?.(7, 5) or JSON_OBJECT?.["get_rectangle_area"]?.(7, 5) ?? "not found"): ', json_stringify((pipe_v2(optional_chaining($JSON_OBJECT_ref, "get_rectangle_area"), sub { optional_chaining([@_]->[0], 7, 5) }) // "not found"))));
# (JSON_OBJECT?.get_rectangle_area?.(7, 5) or JSON_OBJECT?.["get_rectangle_area"]?.(7, 5) ?? "not found"): 35

console_log(string_interpolation('(JSON_OBJECT?.get_circle_area?.(7) or JSON_OBJECT?.["get_circle_area"]?.(7) ?? "not found"): ', json_stringify((pipe_v2(optional_chaining($JSON_OBJECT_ref, "get_circle_area"), sub { optional_chaining([@_]->[0], 7) }) // "not found"))));
# (JSON_OBJECT?.get_circle_area?.(7) or JSON_OBJECT?.["get_circle_area"]?.(7) ?? "not found"): null

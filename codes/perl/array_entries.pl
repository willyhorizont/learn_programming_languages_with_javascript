...
# There's no JavaScript-like Array.entries() in Perl.
# But, we can create our own function to mimic it in Perl.

console_log(string_interpolation("\n# JavaScript-like Array.entries() in Perl Hash"));

my @fruits = ("apple", "banana", "cherry");
console_log(string_interpolation("fruits: ", json_stringify(\@fruits, "pretty" => (1 == 1))));
console_log(string_interpolation("fruits: ", json_stringify([@fruits], "pretty" => (1 == 1))));

console_log(string_interpolation('# using JavaScript-like Array.entries() function "array_entries"'));

console_log(string_interpolation("fruits entries: ", json_stringify(object_from_entries(array_entries(\@fruits)), "pretty" => (1 == 1))));
# fruits entries: {
#     "0": "apple",
#     "1": "banana",
#     "2": "cherry"
...
my $fruits_ref = ["apple", "banana", "cherry"];
console_log(string_interpolation("fruits_ref: ", json_stringify(\@{$fruits_ref}, "pretty" => (1 == 1))));
console_log(string_interpolation("fruits_ref: ", json_stringify($fruits_ref, "pretty" => (1 == 1))));

console_log(string_interpolation('# using JavaScript-like Array.entries() function "array_entries"'));

console_log(string_interpolation("fruits_ref entries: ", json_stringify(object_from_entries(array_entries($fruits_ref)), "pretty" => (1 == 1))));
# fruits entries: {
#     "0": "apple",
#     "1": "banana",
#     "2": "cherry"

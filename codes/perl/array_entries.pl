...
console_log(string_interpolation("fruits_ref: ", json_stringify(\@{$fruits_ref}, "pretty" => "true")));
console_log(string_interpolation("fruits_ref: ", json_stringify($fruits_ref, "pretty" => "true")));

console_log(string_interpolation('# using JavaScript-like Array.entries() function "array_entries"'));

console_log(string_interpolation("fruits_ref entries: ", json_stringify(object_from_entries(array_entries($fruits_ref)), "pretty" => "true")));
# fruits entries: {
#     "0": "apple",
#     "1": "banana",
#     "2": "cherry"

    ...
    function pretty_json_stringify_inner_result = pretty_json_stringify_inner(anything_inner, indent_inner)
        ...
        if (iscell(anything_inner))
            ...
            for array_item_index = 1:numel(anything_inner) % (start:step:stop)
                ...
                result = strcat(result, pretty_json_stringify_inner(array_item, indent_inner));
...
disp(strcat("something{2}: ", something{2}));
disp(strcat("num2str(length(something)): ", num2str(length(something))));

str1 = "Hello, World!";
% str1 = 'Hello, World!';
str1 = char(str1);
disp(strcat("str1: ", str1));
str1length = length(str1);
disp(strcat("num2str(str1length): ", num2str(str1length)));
str1firstchar = str1(1);
% str1firstchar = str1{1}(1);
% str1firstchar = char(str1);
% str1firstchar = str1firstchar(1);
disp(strcat("str1firstchar: ", str1firstchar));
% str1substr = str1{1}(3:4);
str1substr = str1(3:4);
disp(strcat("str1substr: ", str1substr));
str1concat = strcat(str1, ' Hi!');
disp(strcat("str1concat: ", str1concat));
str1findexof = strfind("fg gds ab dgdgab dgdg bab", 'ab');
disp(strcat("str1findexof: ", num2str(str1findexof(1))));
str1include = length(strfind("fg gds ab dgdgab dgdg bab", 'ab')) > 0;
disp(strcat("str1include: ", bool2string(str1include)));
str1rep = strrep(str1, 'Hello', 'Yo');
disp(strcat("str1rep: ", str1rep));
str1split = strsplit('asd zxc', ' ');
disp(strcat("str1split: ", str1split{:}));
str1up = upper(str1);
disp(strcat("str1up: ", str1up));
str1low = lower(str1);
disp(strcat("str1low: ", str1low));

str2c = 'lorem ipsum';
disp(strcat("str2c: ", str2c));
str2s = string(str2c);
disp(strcat("str2s: ", str2s));
...
disp(strcat("mydict.asd: ", mydict.asd));
disp(strcat("isfield(mydict, 'asd'): ", bool2string(isfield(mydict, 'asd'))));
mydict = rmfield(mydict, 'zxc');
disp(strcat("isfield(mydict, 'zxc'): ", bool2string(isfield(mydict, 'zxc'))));
disp(strcat("object.keys() fieldnames(mydict): ", fieldnames(mydict)));

...
friend.each_with_index { |(object_key, object_value), iteration_index| print("friend, foreach loop, iteration/entry index: #{iteration_index}, key: #{object_key}, value: #{object_value}\n") }

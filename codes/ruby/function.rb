...
my_array_of_get_rectangle_area_functions[0].(3, 4)
my_array_of_get_rectangle_area_functions[1].(3, 4)
my_array_of_get_rectangle_area_functions[2].(3, 4)
my_array_of_get_rectangle_area_functions[3].(3, 4)
my_array_of_get_rectangle_area_functions[4].(3, 4)
my_array_of_get_rectangle_area_functions[5].(3, 4)
my_array_of_get_rectangle_area_functions[6].(3, 4)
my_array_of_get_rectangle_area_functions[7].(3, 4)
my_array_of_get_rectangle_area_functions[8].(3, 4)
my_array_of_get_rectangle_area_functions[9].(3, 4)

...
array_filter_v3 = ->(callback_function, an_array) do
    ...
    data_filtered = []
    an_array.each_with_index do |array_item, array_item_index|
        data_filtered = [*data_filtered, array_item] if (callback_function.call(array_item, array_item_index, an_array) == true)
    end
    return data_filtered
end
...
array_filter_v4 = ->(callback_function, an_array) do
    ...
    data_filtered = []
    an_array.each_with_index do |array_item, array_item_index|
        data_filtered = [*data_filtered, array_item] unless (callback_function.call(array_item, array_item_index, an_array) == false)
    end
    return data_filtered
end
...
numbers_even = array_filter_v1.call(->(number, _, _) { ((number % 2) == 0) }, numbers)
print("\n", "even numbers only: ", numbers_even)
# even numbers only: [12, 34, 36, 4, 254]

numbers_odd = array_filter_v1.call(->(number, _, _) { ((number % 2) != 0) }, numbers)
print("\n", "odd numbers only: ", numbers_odd)
# odd numbers only: [27, 23, 65, 93, 87]

print("\n", "# using JavaScript-like Array.filter() function \"array_filter_v2\"")

numbers_even = array_filter_v2.call(->(number, _, _) { ((number % 2) == 0) }, numbers)
print("\n", "even numbers only: ", numbers_even)
# even numbers only: [12, 34, 36, 4, 254]

numbers_odd = array_filter_v2.call(->(number, _, _) { ((number % 2) != 0) }, numbers)
print("\n", "odd numbers only: ", numbers_odd)
# odd numbers only: [27, 23, 65, 93, 87]

print("\n", "# using JavaScript-like Array.filter() function \"array_filter_v3\"")

numbers_even = array_filter_v3.call(->(number, _, _) { ((number % 2) == 0) }, numbers)
print("\n", "even numbers only: ", numbers_even)
# even numbers only: [12, 34, 36, 4, 254]

numbers_odd = array_filter_v3.call(->(number, _, _) { ((number % 2) != 0) }, numbers)
print("\n", "odd numbers only: ", numbers_odd)
# odd numbers only: [27, 23, 65, 93, 87]

print("\n", "# using JavaScript-like Array.filter() function \"array_filter_v4\"")

numbers_even = array_filter_v4.call(->(number, _, _) { ((number % 2) == 0) }, numbers)
print("\n", "even numbers only: ", numbers_even)
# even numbers only: [12, 34, 36, 4, 254]

numbers_odd = array_filter_v4.call(->(number, _, _) { ((number % 2) != 0) }, numbers)
print("\n", "odd numbers only: ", numbers_odd)
# odd numbers only: [27, 23, 65, 93, 87]
...
products_below_100 = array_filter_v1.call(->(product, _, _) { (product["price"] <= 100) }, products)
...
products_below_100 = array_filter_v2.call(->(product, _, _) { (product["price"] <= 100) }, products)
print("\n", "products with price <= 100 only: ", JSON.pretty_generate(products_below_100, { "indent": " " * 4 }))
# products with price <= 100 only: [
#     {
#         "code": "potato_chips",
...
products_below_100 = array_filter_v3.call(->(product, _, _) { (product["price"] <= 100) }, products)
print("\n", "products with price <= 100 only: ", JSON.pretty_generate(products_below_100, { "indent": " " * 4 }))
# products with price <= 100 only: [
#     {
#         "code": "potato_chips",
...
products_below_100 = array_filter_v4.call(->(product, _, _) { (product["price"] <= 100) }, products)
print("\n", "products with price <= 100 only: ", JSON.pretty_generate(products_below_100, { "indent": " " * 4 }))
# products with price <= 100 only: [
#     {
#         "code": "potato_chips",

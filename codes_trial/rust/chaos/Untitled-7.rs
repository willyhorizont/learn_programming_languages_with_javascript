...
fn main() {
    ...
    let numbers_total_1 = array_reduce_v1(|current_result, current_number, _, _| {
        ...
        return serde_json::Value::from(0);
    }, &numbers["json"].as_array().unwrap(), serde_json::Value::from(0));
    ...
    if let serde_json::Value::Array(an_array) = &numbers["json"] {
        ...
        let numbers_total_2 = array_reduce_v1(|current_result, current_number, _, _| {
            ...
            return serde_json::Value::from(0);
        }, &an_array, serde_json::Value::from(0));
    ...
    let numbers_total_3 = array_reduce_v1(|current_result, current_number, _, _| {
        ...
        return serde_json::Value::from(0);
    }, &numbers_even_8, serde_json::Value::from(0));
    ...
    let numbers_total_5 = array_reduce_v1(|current_result, current_number, _, _| {
        ...
        return serde_json::Value::from(0.0);
    }, &numbers2["json"].as_array().unwrap(), serde_json::Value::from(0.0));

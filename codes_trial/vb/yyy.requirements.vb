...
Module Program
    Sub Main(args As String())
        Dim PrettyJsonStringify As Func(Of Object, String) = Function(ByVal Anything)
            ...
            Dim PrettyJsonStringifyInner As Func(Of Object, String) = Function(ByVal AnythingInner)
                ...
                If TypeOf AnythingInner Is Object() Then
                    IndentLevel += 1
                    Dim Result As String = "[" & Environment.NewLine & String.Concat(Enumerable.Repeat(Indent, IndentLevel))

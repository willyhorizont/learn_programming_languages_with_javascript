def MyObject(anObject: Any): Map[String, Any] = anObject.asInstanceOf[Map[String, Any]]
def MyArray(arrayItems: Any*): Array[Any] = arrayItems.toArray.asInstanceOf[Array[Any]]
...
val combination1 = fruits ++ vegetables
...
val combination2 = fruits ++ MyArray("Cucumber", "Cabbage")
...
val combination3 = countryCapitalsInAsia ++ countryCapitalsInEurope
...
val combination4 = countryCapitalsInAsia ++ MyObject(Map("Germany" -> "Berlin", "Italy" -> "Rome"))
...
val combination5 = fruits :+ vegetables
...
val combination6 = fruits :+ MyArray("Cucumber", "Cabbage")
...
val combination7 = fruits :+ countryCapitalsInAsia
...
val combination8 = fruits :+ MyObject(Map("Germany" -> "Berlin", "Italy" -> "Rome"))
...
val combination9 = countryCapitalsInAsia ++ MyObject(Map("countryCapitalsInEurope" -> countryCapitalsInEurope))
...
val combination10 = countryCapitalsInAsia ++ MyObject(Map("countryCapitalsInEurope" -> MyObject(Map("Germany" -> "Berlin", "Italy" -> "Rome"))))
...
val combination11 = countryCapitalsInAsia ++ MyObject(Map("vegetables" -> vegetables))
...
val combination12 = countryCapitalsInAsia ++ MyObject(Map("vegetables" -> MyArray("Cucumber", "Cabbage")))
...
val combination13 = countryCapitalsInAsia ++ arrayToObject(vegetables)
...
val combination14 = countryCapitalsInAsia ++ arrayToObject(MyArray("Cucumber", "Cabbage"))
...
// val combinationErrorInJavascript1 = fruits :+ countryCapitalsInAsia
// println(s"combinationErrorInJavascript1: ${jsonStringify(combinationErrorInJavascript1, pretty = true)}")

// this combination throw an error in JavaScript
// val combinationErrorInJavascript2 = fruits :+ MyObject(Map("Germany" -> "Berlin", "Italy" -> "Rome"))

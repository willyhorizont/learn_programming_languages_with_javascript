...
let encryptToNatoPhoneticAlphabet = { (aString: String) -> String in aString.split(separator: "").filter { (spreadSyntaxObject(NATO, [",": ",", ".": ".", "!": "!", "?": "?"] as MyObject).keys.contains($0.uppercased())) }.map { (allowedCharacter: Substring) -> String in spreadSyntaxObject(NATO, [",": ",", ".": ".", "!": "!", "?": "?"] as MyObject)[allowedCharacter.uppercased()] as! String }.joined(separator: " ") }

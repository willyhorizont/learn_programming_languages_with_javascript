...
let natoPhoneticAlphabet: MyObject = [
    "A": "Alfa",
    "B": "Bravo",
    "C": "Charlie",
    "D": "Delta",
...
let encryptToNatoPhoneticAlphabet = { (aString: String) -> String in aString.split(separator: "").filter { (natoPhoneticAlphabet.keys.contains($0.uppercased())) }.map { (allowedCharacter: Substring) -> String in natoPhoneticAlphabet[allowedCharacter.uppercased()] as! String }.joined(separator: " ") }

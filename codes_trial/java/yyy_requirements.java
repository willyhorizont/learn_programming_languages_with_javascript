...
class yyy_requirements {
    public static HashMap createNewObject(Pair<String, Object>... parameters) {
        HashMap<String, Object> newObject = new HashMap<>();
        try {
            for (int i = 0; i < parameters.length; i += 1) {
                newObject.put(parameters[i].getKey(), parameters[i].getValue());
            }
        } catch (Exception ex) {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println("something: " + something);
        something = createNewObject(new Pair<String, Object>("foo", "bar"));
        System.out.println("something: " + something);
        ...
        */
        ...
        ```
        */
        Object[] myArray = new Object[]{"foo", 123, true, null, new Object[]{1, 2, 3}, createNewObject(new Pair<String, Object>("foo", "bar"))};
        ...
        */
        Object[] myArray2 = new Object[]{
            ...
            null,
            new Object[]{1, 2, 3},
            createNewObject(new Pair<String, Object>("foo", "bar"))
        };
        System.out.println("myArray2[0](7, 5): " + ((LambdaArgs2<Integer, Integer, Integer>) myArray2[0]).apply(7, 5));

        HashMap<String, Object> myObject2 = createNewObject(
